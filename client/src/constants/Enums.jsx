...
export const company_change_date_category = {
  YYYYMMMMDD: 0,
  YYYYMMMM: 1,
  YYYY: 2,
  YYYYQ1: 3,
...
export const company_start_date_category = {
  YYYYMMMMDD: 0,
  YYYYMMMM: 1,
  YYYY: 2,
  YYYYQ1: 3,
...
export const company_website_category = {
  official: 1,
  wikia: 2,
  wikipedia: 3,
  facebook: 4,
...
export const external_game_media = {
  digital: 1,
  physical: 2
}
...
export const game_version_feature_category = {
  boolean: 0,
  description: 1
}

export const game_version_feature_value_included_feature = {
  NOT_INCLUDED: 0,
  INCLUDED: 1,
  PRE_ORDER_ONLY: 2
}
...
export const platform_version_release_date_category = {
  YYYYMMMMDD: 0,
  YYYYMMMM: 1,
  YYYY: 2,
  YYYYQ1: 3,
...
export const platform_version_release_date_region = {
  europe: 1,
  north_america: 2,
  australia: 3,
  new_zealand: 4,
...
export const platform_website_category = {
  official: 1,
  wikia: 2,
  wikipedia: 3,
  facebook: 4,
...
export const release_date_category = {
  YYYYMMMMDD: 0,
  YYYYMMMM: 1,
  YYYY: 2,
  YYYYQ1: 3,
...
export const release_date_region = {
  europe: 1,
  north_america: 2,
  australia: 3,
  new_zealand: 4,
